...
//			convertToIcSubjcet(line);
            ...
            log.info("price_info_json update1 info :"+JSON.toJSONString(linePublishDTOForUpdate));
            ...
            if (CollectionUtils.isNotEmpty(unnecessaryItemSkuDO)) {
                ...
                log.info("price_info_json update2 info :"+JSON.toJSONString(linePublishDTOForUpdate2));
...
//			convertToIcSubjcet(line);
            ...
            log.info("price_info_json save info :"+JSON.toJSONString(linePublishDTOForSave));
...
//					commentRepo.saveTagRelation(itemId, TagType.DEPARTPLACE, departIds);
                    ...
                    commentRepo.addLineTagRelationInfo(itemId, TagType.DEPARTPLACE, departIds);//edited by xushubing 20160829
                }
                List<CityVO> dests = baseInfo.getDests();
                List<Long> destIds = new ArrayList<Long>();
//				for (TagDTO tagDTO : dests) {
