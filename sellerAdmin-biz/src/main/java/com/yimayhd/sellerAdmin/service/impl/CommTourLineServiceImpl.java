 ...
 *
 */
public class CommTourLineServiceImpl implements CommFreeLineService {
	...
	@Override
	public FreeLineVO getById(long id) {
		...
		return LineConverter.toFreeLineVO(lineResult, tags);
	}

	@Override
	public long publishLine(FreeLineVO line) {
