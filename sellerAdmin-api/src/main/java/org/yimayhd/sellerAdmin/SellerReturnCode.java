...
public class SellerReturnCode extends AbstractReturnCode implements Serializable {
	...
	*/
    ...
    public static final SellerReturnCode ON_SALE_ERROR= new SellerReturnCode(SYSTEM_ERROR_C, "上架失败");
    public static final int OFF_SALE_ERROR_C = 24005003;
    public static final SellerReturnCode OFF_SALE_ERROR = new SellerReturnCode(SYSTEM_ERROR_C, "下架失败");
    public static final int DELETE_ERROR_C = 24005004;
    public static final SellerReturnCode DELETE_ERROR = new SellerReturnCode(SYSTEM_ERROR_C, "删除失败");
    public static final int ON_SALE_SUCCESS_C = 24005005;
    public static final SellerReturnCode ON_SALE_SUCCESS= new SellerReturnCode(SYSTEM_ERROR_C, "上架成功");
