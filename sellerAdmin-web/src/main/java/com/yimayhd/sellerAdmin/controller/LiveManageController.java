...
public class LiveManageController extends BaseController {
	...
	public String toAdd(Model model) throws Exception {
		List<ComTagDO> comTagDOList = tagRepo.getTagsByTagType(TagType.LIVESUPTAG);
	...
	@ResponseBody
	public ResponseVo batchPublish(@RequestParam("liveIdList[]") ArrayList<Long> liveIdList) throws Exception {
	 ...
	 * @throws Exception
	 *//*
		 * @RequestMapping(value = "/picture/{trendId}", method =
		 * RequestMethod.GET)
		 * 
		 * @ResponseBody public ResponseVo
		 * getPictureById(@PathVariable("trendId") Long trendId) throws
		 * Exception { List<String> pictureUrlList =
		 * liveService.getById(trendId).getPictureUrlList(); return new
		 * ResponseVo(pictureUrlList); }
		 */
